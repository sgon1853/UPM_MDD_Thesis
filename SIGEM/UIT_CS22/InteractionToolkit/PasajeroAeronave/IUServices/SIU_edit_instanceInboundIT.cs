...
namespace SIGEM.Client.InteractionToolkit.PasajeroAeronave.IUServices
{
	...
	public partial class SIU_edit_instanceInboundIT : Form
	{
		...
		public SIU_edit_instanceInboundIT()
		{
			...
			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.PasajeroAeronave_SIU_SIU_edit_instance);
		}
		...
		{
			Controller = ControllerFactory.PasajeroAeronave.Service_edit_instanceInbound(exchangeInfo, null);
