...
namespace SIGEM.Client.InteractionToolkit.NaveNodriza.IUServices
{
	...
	public partial class SIU_edit_instanceInboundIT : Form
	{
		...
		public SIU_edit_instanceInboundIT()
		{
			...
			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.NaveNodriza_SIU_SIU_edit_instance);
		}
		...
		{
			Controller = ControllerFactory.NaveNodriza.Service_edit_instanceInbound(exchangeInfo, null);
