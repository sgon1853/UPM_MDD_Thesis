...
namespace SIGEM.Client.InteractionToolkit.NaveNodriza.IUInstances
{
	...
	public partial class _Auto_IT : Form
	{
		...
		public _Auto_IT()
		{
			...
			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.NaveNodriza_IIU__Auto_);
		}
		...
		{
			// Controller factory.
			Controller = ControllerFactory.NaveNodriza.Instance__Auto_(exchangeInfo);
			...
			// DisplaySet
			Controller.DisplaySet.Viewer = new ListViewPresentation(lstViewDisplaySet, toolStripExportExcel, toolStripExportWord, toolStripRefresh, toolStripHelp, optionsToolStripMenuItem, null);
			// OID Selector
            Controller.OidSelector.Label = new LabelPresentation(this.lOIDSelector);
			Controller.OidSelector.Editors[0] = new MaskedTextBoxPresentation(this.maskedTextBoxid_NaveNodriza1);
