...
namespace SIGEM.Client.InteractionToolkit.Aeronave.IUPopulations
{
	/// <summary>
	/// PIU_AeronaveIT population form of the application.
	/// </summary>
	public partial class PIU_AeronaveIT : Form
	{
		#region Members
		/// <summary>
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the 'PIU_AeronaveIT' class.
		/// </summary>
		public PIU_AeronaveIT()
		{
			InitializeComponent();

			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.Aeronave_PIU_PIU_Aeronave);
		}
		#endregion Constructors

		#region Initialize
		/// <summary>
		/// Initializes the 'PIU_AeronaveIT' instance form
		/// </summary>
		...
		public IUPopulationController Initialize(ExchangeInfo exchangeInfo)
		{
			...
			// Controller factory.
			Controller = ControllerFactory.Aeronave.Population_PIU_Aeronave(exchangeInfo);
			Controller.Scenario = new ScenarioPresentation(this, ScenarioType.Population);


			#region Population PIU_Aeronave Links
			...
			#endregion Population PIU_Aeronave Links
