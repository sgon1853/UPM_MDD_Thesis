...
namespace SIGEM.Client.InteractionToolkit.Aeronave.IUServices
{
	...
	public partial class SIU_edit_instanceInboundIT : Form
	{
		...
		public SIU_edit_instanceInboundIT()
		{
			...
			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.Aeronave_SIU_SIU_edit_instance);
		}
		...
		{
			Controller = ControllerFactory.Aeronave.Service_edit_instanceInbound(exchangeInfo, null);
