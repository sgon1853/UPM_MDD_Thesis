...
namespace SIGEM.Client.InteractionToolkit.RevisionPasajero.IUServices
{
	...
	public partial class SIU_edit_instanceInboundIT : Form
	{
		...
		public SIU_edit_instanceInboundIT()
		{
			...
			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.RevisionPasajero_SIU_SIU_edit_instance);
		}
		...
		{
			Controller = ControllerFactory.RevisionPasajero.Service_edit_instanceInbound(exchangeInfo, null);
