...
namespace SIGEM.Client.InteractionToolkit.Pasajero.IUServices
{
	...
	public partial class SIU_delete_instanceInboundIT : Form
	{
		...
		public SIU_delete_instanceInboundIT()
		{
			...
			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.Pasajero_SIU_SIU_delete_instance);
		}
		...
		{
			Controller = ControllerFactory.Pasajero.Service_delete_instanceInbound(exchangeInfo, null);
