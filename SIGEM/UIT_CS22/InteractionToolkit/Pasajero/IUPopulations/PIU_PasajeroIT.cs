...
{
	/// <summary>
	/// PIU_PasajeroIT population form of the application.
	/// </summary>
	public partial class PIU_PasajeroIT : Form
	{
		#region Members
		/// <summary>
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the 'PIU_PasajeroIT' class.
		/// </summary>
		public PIU_PasajeroIT()
		{
			InitializeComponent();

			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.Pasajero_PIU_PIU_Pasajero);
		}
		#endregion Constructors

		#region Initialize
		/// <summary>
		/// Initializes the 'PIU_PasajeroIT' instance form
		/// </summary>
		...
		public IUPopulationController Initialize(ExchangeInfo exchangeInfo)
		{
			...
			// Controller factory.
			Controller = ControllerFactory.Pasajero.Population_PIU_Pasajero(exchangeInfo);
