...
namespace SIGEM.Client.InteractionToolkit.Pasajero.IUInstances
{
	...
	public partial class _Auto_IT : Form
	{
		...
		public _Auto_IT()
		{
			...
			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.Pasajero_IIU__Auto_);
		}
		...
		{
			// Controller factory.
			Controller = ControllerFactory.Pasajero.Instance__Auto_(exchangeInfo);
			...
			Controller.OidSelector.Editors[0] = new MaskedTextBoxPresentation(this.maskedTextBoxid_Pasajero1);
