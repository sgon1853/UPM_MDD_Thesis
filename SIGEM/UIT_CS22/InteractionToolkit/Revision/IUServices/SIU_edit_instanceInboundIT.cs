...
namespace SIGEM.Client.InteractionToolkit.Revision.IUServices
{
	...
	public partial class SIU_edit_instanceInboundIT : Form
	{
		...
		public SIU_edit_instanceInboundIT()
		{
			...
			// Icon assignament.
			this.Icon = UtilFunctions.BitmapToIcon(Properties.Resources.Revision_SIU_SIU_edit_instance);
		}
		...
		{
			Controller = ControllerFactory.Revision.Service_edit_instanceInbound(exchangeInfo, null);
