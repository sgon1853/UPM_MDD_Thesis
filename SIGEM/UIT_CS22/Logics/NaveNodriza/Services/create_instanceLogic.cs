...
namespace SIGEM.Client.Logics.NaveNodriza.Services
{
	...
	public static class create_instanceLogic
	{
		...
		private static Dictionary<string, object> GetInputFieldValues(int? p_atrid_NaveNodrizaArg, string p_atrNombre_NaveNodrizaArg)
		{
			// Fill values dictionary.
			Dictionary<string, object> lValues = new Dictionary<string, object>();
			lValues.Add("p_atrid_NaveNodriza", p_atrid_NaveNodrizaArg);
			lValues.Add("p_atrNombre_NaveNodriza", p_atrNombre_NaveNodrizaArg);
		...
		public static Dictionary<string, ModelType> GetInboundArgumentTypes()
		{
			...
			lTypes.Add("p_atrid_NaveNodriza", ModelType.Autonumeric);
			lTypes.Add("p_atrNombre_NaveNodriza", ModelType.String);
		...
		{
			return ExecuteService(agent, argumentValues["p_atrid_NaveNodriza"] as int?, argumentValues["p_atrNombre_NaveNodriza"] as string);
		}
		/// <summary>
		/// Method that solves the execution of 'create_instance' service.
		/// </summary>
		...
		public static void ExecuteValidateValue(Oid agent, string argumentName, object argumentValue)
		{
			...
			{	
				case "p_atrid_NaveNodriza":
					ExecuteValidateValuep_atrid_NaveNodriza(agent, argumentValue as int?);
					break;
				case "p_atrNombre_NaveNodriza":
					ExecuteValidateValuep_atrNombre_NaveNodriza(agent, argumentValue as string);
					break;
				default:
					break;
			}
		...
		/// <summary>
		/// Solves the validation of the 'p_atrid_NaveNodriza' inbound argument.
		/// </summary>
		/// <param name="agent">Application agent</param>
		/// <param name="argumentValue">Value of the inbound argument to validate</param>
		public static void ExecuteValidateValuep_atrid_NaveNodriza(Oid agent, int? argumentValue)
		{
			// TODO: Validate value
		}
		/// <summary>
		/// Solves the validation of the 'p_atrNombre_NaveNodriza' inbound argument.
		/// </summary>
		/// <param name="agent">Application agent</param>
		/// <param name="argumentValue">Value of the inbound argument to validate</param>
		public static void ExecuteValidateValuep_atrNombre_NaveNodriza(Oid agent, string argumentValue)
		{
			// TODO: Validate value
		}
