...
namespace SIGEM.Client.Logics.PasajeroAeronave
{
	/// <summary>
	...
	public static class ClassLogic
	{
		...
		public static DataTable ExecuteQueryInstance(Oid agent, Oid oid, string displaySet)
		{
			try
			{
				return ExecuteQueryInstance(agent, new PasajeroAeronaveOid(oid), displaySet);
			}
			catch
			{
				return null;
		...
		{
			DataTable lDataTable = Logic.Adaptor.ExecuteQueryRelated(agent, "PasajeroAeronave", linkItems, displaySet, orderCriteria, navigationalFiltering, lastOid, blockSize);
		...
		/// <summary>
		/// Execute a query related with a Aeronave
		/// </summary>
		/// <param name="agent">Application agent</param>
		/// <param name="relatedOid">Aeronave oid related</param>
		/// <param name="displaySet">List of attributes to return</param> 
		/// <param name="orderCriteria">Order criteria name</param>
		...
		public static DataTable ExecuteQueryRelatedAeronave(Oid agent, AeronaveOid relatedOid, string displaySet, string orderCriteria, PasajeroAeronaveOid lastOid, int blockSize, ref bool lastBlock)
		{
			Dictionary<string, Oid> lLinkItems = new Dictionary<string, Oid>(StringComparer.CurrentCultureIgnoreCase);
			lLinkItems.Add("Aeronave", relatedOid);
		...
		/// <summary>
		/// Decides if the action SIU_create_instance of PasajeroAeronave has to be enabled or disabled ("1" / "0").
		/// </summary>
		...
		private static string Action_PasajeroAeronave_SIU_create_instance(IUQueryContext context, DataRow row, string actionItemIdXML)
		{
			return "1";
		}
		...
		/// <summary>
		/// Decides if the action SIU_edit_instance of PasajeroAeronave has to be enabled or disabled ("1" / "0").
		/// </summary>
		/// <param name="context">IUQueryContext object received.</param>
		/// <param name="row">DataRow that contains the data of the instance selected.</param>
		/// <param name="actionItemIdXML">XML identificator of the action element.</param>
		/// <returns>A string indicating if the action element has to be enabled "1" or disabled "0".</returns>
		private static string Action_PasajeroAeronave_SIU_edit_instance(IUQueryContext context, DataRow row, string actionItemIdXML)
		{
			return "1";
		}

		/// <summary>
		/// Decides if the action IIU_PasajeroAeronave of PasajeroAeronave has to be enabled or disabled ("1" / "0").
		/// </summary>
		/// <param name="context">IUQueryContext object received.</param>
		/// <param name="row">DataRow that contains the data of the instance selected.</param>
		/// <param name="actionItemIdXML">XML identificator of the action element.</param>
		/// <returns>A string indicating if the action element has to be enabled "1" or disabled "0".</returns>
		private static string Action_PasajeroAeronave_IIU_PasajeroAeronave(IUQueryContext context, DataRow row, string actionItemIdXML)
		{
			return "1";
		}
		...
		private static string GetEnabledNavigation(IUQueryContext context, DataRow row, string navigationKey)
		{
			try
			{
				...
				{
					case "Clas_1348178542592177NavOfer_AutoElemNav_1_Alias":
						{
							return getNavigation_RevisionPasajero__Auto__RevisionPasajero(context, row, navigationKey);
						}
					case "Clas_1348178542592177NavOfer_AutoElemNav_2_Alias":
						{
							return getNavigation_Aeronave__Auto__Aeronave(context, row, navigationKey);
						}
					case "Clas_1348178542592177NavOfer_AutoElemNav_3_Alias":
						{
							return getNavigation_Pasajero__Auto__Pasajero(context, row, navigationKey);
						}
					default:
						return "1";
				}
		...
		/// <param name="navigationItemIdXML">XML identificator of the navigation element.</param>
		/// <returns>A string indicating if the navigation element has to be enabled "1" or disabled "0".</returns>
		private static string getNavigation_Pasajero__Auto__Pasajero(IUQueryContext context, DataRow row, string navigationItemIdXML)
		{
			return "1";
		}
		...
		public static List<string> GetIdentificationFunctionFields()
		{
			...
			lFields.Add("id_PasajeroAeronave"); //Attribute Name is id_PasajeroAeronave
