...
namespace SIGEM.Client.Logics.Pasajero.Services
{
	/// <summary>
	...
	public static class create_instanceLogic
	{
		...
		/// <param name="p_atrid_PasajeroArg">Value of the inbound argument 'p_atrid_Pasajero'.</param>
		...
		private static Dictionary<string, object> GetInputFieldValues(PasajeroAeronaveOid p_agrPasajeroAeronaveArg, int? p_atrid_PasajeroArg, string p_atrNombreArg)
		{
			...
			lValues.Add("p_atrid_Pasajero", p_atrid_PasajeroArg);
		...
		public static Dictionary<string, ModelType> GetInboundArgumentTypes()
		{
			...
			lTypes.Add("p_atrid_Pasajero", ModelType.Autonumeric);
		...
		{
			context.OutputFields = ExecuteService(context.Agent, context.GetInputFieldValue("p_agrPasajeroAeronave") as List<Oid>, context.GetInputFieldValue("p_atrid_Pasajero") as int?, context.GetInputFieldValue("p_atrNombre") as string);
		}
		/// <summary>
		/// Method that solves the execution of 'create_instance' service.
		/// </summary>
		...
		{
			return ExecuteService(agent, argumentValues["p_agrPasajeroAeronave"] as List<Oid>, argumentValues["p_atrid_Pasajero"] as int?, argumentValues["p_atrNombre"] as string);
		}
		/// <summary>
		/// Method that solves the execution of 'create_instance' service.
		/// </summary>
		...
		/// <param name="p_atrNombreArg">Value of the inbound argument 'p_atrNombre'.</param>
		/// <returns>Outbound argument values.</returns>
		public static Dictionary<string, object> ExecuteService(Oid agent, List<Oid> p_agrPasajeroAeronaveArg, int? p_atrid_PasajeroArg, string p_atrNombreArg)
		{
			...
			Dictionary<string, object> lValues = GetInputFieldValues(lp_agrPasajeroAeronave, p_atrid_PasajeroArg, p_atrNombreArg);
			Dictionary<string, ModelType> lTypes = GetInboundArgumentTypes();
			Dictionary<string, string> lDomains = GetInboundArgumentDomains();

			Dictionary<string, object> lOutboundArguments = Logic.Adaptor.ExecuteService(agent, "Pasajero", "create_instance", lTypes, lValues, lDomains);
		...
		public static void ExecuteValidateValue(IUServiceContext context)
		{
			...
			{	
				case "p_agrPasajeroAeronave":
					...
					break;
				case "p_atrid_Pasajero":
					ExecuteValidateValuep_atrid_Pasajero(context.Agent, context.GetInputFieldValue("p_atrid_Pasajero") as int?);
					break;
				case "p_atrNombre":
		...
		public static void ExecuteValidateValue(Oid agent, string argumentName, object argumentValue)
		{
			...
			{	
				case "p_agrPasajeroAeronave":
					...
					break;
				case "p_atrid_Pasajero":
					ExecuteValidateValuep_atrid_Pasajero(agent, argumentValue as int?);
					break;
				case "p_atrNombre":
		...
		/// <summary>
		/// Solves the validation of the 'p_atrid_Pasajero' inbound argument.
		/// </summary>
		/// <param name="agent">Application agent</param>
		/// <param name="argumentValue">Value of the inbound argument to validate</param>
		public static void ExecuteValidateValuep_atrid_Pasajero(Oid agent, int? argumentValue)
		{
			// TODO: Validate value
		}
		/// <summary>
