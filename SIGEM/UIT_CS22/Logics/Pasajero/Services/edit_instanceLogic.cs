...
namespace SIGEM.Client.Logics.Pasajero.Services
{
	...
	public static class edit_instanceLogic
	{
		...
		public static Dictionary<string, ModelType> GetInboundArgumentTypes()
		{
			...
			lTypes.Add("p_thisPasajero", ModelType.Oid);
		...
		public static Dictionary<string, string> GetInboundArgumentDomains()
		{
			...
			lDomains.Add("p_thisPasajero", "Pasajero");
		...
		{
			return ExecuteService(agent, argumentValues["p_thisPasajero"] as List<Oid>);
		}
		/// <summary>
		/// Method that solves the execution of 'edit_instance' service.
		/// </summary>
		...
		public static Dictionary<string, object> ExecuteService(Oid agent, List<Oid> p_thisPasajeroArg)
		{
			...
			Dictionary<string, object> lOutboundArguments = Logic.Adaptor.ExecuteService(agent, "Pasajero", "edit_instance", lTypes, lValues, lDomains);
		...
		public static void ExecuteValidateValue(Oid agent, string argumentName, object argumentValue)
		{
			...
			{	
				case "p_thisPasajero":
					ExecuteValidateValuep_thisPasajero(agent, argumentValue as List<Oid>);
					break;
				default:
					break;
			}
		...
		/// <summary>
		/// Solves the validation of the 'p_thisPasajero' inbound argument.
		/// </summary>
		/// <param name="agent">Application agent</param>
		/// <param name="argumentValue">Value of the inbound argument to validate</param>
		public static void ExecuteValidateValuep_thisPasajero(Oid agent, List<Oid> argumentValue)
		{
			// TODO: Validate value
		}
