...
namespace SIGEM.Client.Logics.RevisionPasajero
{
	/// <summary>
	...
	public static class ClassLogic
	{
		...
		public static DataTable ExecuteQueryInstance(Oid agent, Oid oid, string displaySet)
		{
			try
			{
				return ExecuteQueryInstance(agent, new RevisionPasajeroOid(oid), displaySet);
			}
			catch
			{
				return null;
		...
		{
			DataTable lDataTable = Logic.Adaptor.ExecuteQueryRelated(agent, "RevisionPasajero", linkItems, displaySet, orderCriteria, navigationalFiltering, lastOid, blockSize);
		...
		/// <summary>
		/// Decides if the action SIU_create_instance of RevisionPasajero has to be enabled or disabled ("1" / "0").
		/// </summary>
		...
		private static string Action_RevisionPasajero_SIU_create_instance(IUQueryContext context, DataRow row, string actionItemIdXML)
		{
			return "1";
		}

		/// <summary>
		/// Decides if the action SIU_delete_instance of RevisionPasajero has to be enabled or disabled ("1" / "0").
		/// </summary>
		/// <param name="context">IUQueryContext object received.</param>
		/// <param name="row">DataRow that contains the data of the instance selected.</param>
		/// <param name="actionItemIdXML">XML identificator of the action element.</param>
		/// <returns>A string indicating if the action element has to be enabled "1" or disabled "0".</returns>
		private static string Action_RevisionPasajero_SIU_delete_instance(IUQueryContext context, DataRow row, string actionItemIdXML)
		{
			return "1";
		}
		...
		public static List<string> GetIdentificationFunctionFields()
		{
			...
			lFields.Add("id_RevisionPasajero"); //Attribute Name is id_RevisionPasajero
