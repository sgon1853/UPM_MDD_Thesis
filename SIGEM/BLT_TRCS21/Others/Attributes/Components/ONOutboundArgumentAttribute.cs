...
{
	/// <summary>
	/// Attribute related with the outbounds arguments defined in the model object.
	/// </summary>
	[AttributeUsage(AttributeTargets.Parameter)]
	internal class ONOutboundArgumentAttribute: Attribute, IONContextArgumentAttribute
	{
		#region Members
		...
		public ONOutboundArgumentAttribute(string idArgument, string argumentName, string type, string idService, string serviceName, string idClass, string className)
		{
