...
{
	[ONQueryClassAttribute("Administrador")]
	internal class AdministradorQuery : ONQuery
	{
		#region Members
		#endregion Members
		...
		public AdministradorQuery(ONContext onContext) : base(onContext, "Administrador", false)
		{
		}
