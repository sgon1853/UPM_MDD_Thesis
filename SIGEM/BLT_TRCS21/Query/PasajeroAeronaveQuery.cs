...
{
	[ONQueryClassAttribute("PasajeroAeronave")]
	internal class PasajeroAeronaveQuery : ONQuery
	{
		#region Members
		public RevisionPasajeroQuery RevisionPasajeroRoleTemp;
		public AeronaveQuery AeronaveRoleTemp;
		public PasajeroQuery PasajeroRoleTemp;
		#endregion Members
		
		#region Constructors
		/// <summary>Constructor</summary>
		/// <param name="onContext">This parameter has the current context</param>
		public PasajeroAeronaveQuery(ONContext onContext) : base(onContext, "PasajeroAeronave", false)
		{
		}
