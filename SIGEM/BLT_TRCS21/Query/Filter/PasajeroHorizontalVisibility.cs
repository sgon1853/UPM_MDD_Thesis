...
namespace SIGEM.Business.Query
{
	...
	///</summary>
	internal partial class PasajeroHorizontalVisibility : ONFilter
	{
		#region Members
		...
		#region Constructors
		protected PasajeroHorizontalVisibility(string className, string filterName)
			:base (className, filterName)
		{
			InMemory = false;
			InData = false;
		}
		public PasajeroHorizontalVisibility()
			:this ("Pasajero", "HorizontalVisibility")
		{
		}
