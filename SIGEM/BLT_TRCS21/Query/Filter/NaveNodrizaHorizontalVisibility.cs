...
namespace SIGEM.Business.Query
{
	...
	///</summary>
	internal partial class NaveNodrizaHorizontalVisibility : ONFilter
	{
		#region Members
		...
		#region Constructors
		protected NaveNodrizaHorizontalVisibility(string className, string filterName)
			:base (className, filterName)
		{
			InMemory = false;
			InData = false;
		}
		public NaveNodrizaHorizontalVisibility()
			:this ("NaveNodriza", "HorizontalVisibility")
		{
		}
