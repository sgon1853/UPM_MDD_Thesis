...
namespace SIGEM.Business.Query
{
	...
	///</summary>
	internal partial class PasajeroAeronaveHorizontalVisibility : ONFilter
	{
		#region Members
		...
		#region Constructors
		protected PasajeroAeronaveHorizontalVisibility(string className, string filterName)
			:base (className, filterName)
		{
			InMemory = false;
			InData = false;
		}
		public PasajeroAeronaveHorizontalVisibility()
			:this ("PasajeroAeronave", "HorizontalVisibility")
		{
		}
