...
namespace SIGEM.Business.Query
{
	...
	///</summary>
	internal partial class RevisionHorizontalVisibility : ONFilter
	{
		#region Members
		...
		#region Constructors
		protected RevisionHorizontalVisibility(string className, string filterName)
			:base (className, filterName)
		{
			InMemory = false;
			InData = false;
		}
		public RevisionHorizontalVisibility()
			:this ("Revision", "HorizontalVisibility")
		{
		}
