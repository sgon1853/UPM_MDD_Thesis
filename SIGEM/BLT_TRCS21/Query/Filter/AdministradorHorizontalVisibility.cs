...
namespace SIGEM.Business.Query
{
	...
	internal partial class AdministradorHorizontalVisibility : ONFilter
	{
		...
		#region Constructors
		protected AdministradorHorizontalVisibility(string className, string filterName)
			:base (className, filterName)
		{
			InMemory = false;
			InData = false;
		}
		public AdministradorHorizontalVisibility()
			:this ("Administrador", "HorizontalVisibility")
		{
		}
