...
namespace SIGEM.Business.Query
{
	...
	///</summary>
	internal partial class AeronaveHorizontalVisibility : ONFilter
	{
		#region Members
		...
		#region Constructors
		protected AeronaveHorizontalVisibility(string className, string filterName)
			:base (className, filterName)
		{
			InMemory = false;
			InData = false;
		}
		public AeronaveHorizontalVisibility()
			:this ("Aeronave", "HorizontalVisibility")
		{
		}
