...
{
	[ONQueryClassAttribute("RevisionPasajero")]
	internal class RevisionPasajeroQuery : ONQuery
	{
		#region Members
		public RevisionQuery RevisionRoleTemp;
		public PasajeroAeronaveQuery PasajeroAeronaveRoleTemp;
		#endregion Members
		
		#region Constructors
		/// <summary>Constructor</summary>
		/// <param name="onContext">This parameter has the current context</param>
		public RevisionPasajeroQuery(ONContext onContext) : base(onContext, "RevisionPasajero", false)
		{
		}
		...
		public override ONCollection QueryByFilter(ONLinkedToList linkedTo, ONFilterList filters, ONDisplaySet displaySet, string orderCriteria, ONOid startRowOID, int blockSize)
		{
			...
			filters.Add("HorizontalVisibility", new RevisionPasajeroHorizontalVisibility());
			...
			catch (Exception e)
			{
				...
				{
					string ltraceItem = "Error in query, Method: ExecuteQuery, Component: RevisionPasajeroQuery";
