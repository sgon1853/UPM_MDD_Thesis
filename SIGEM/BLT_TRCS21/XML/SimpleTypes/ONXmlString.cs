...
{
	/// <summary>
	/// Basic Type ONXmlString
	/// </summary>
	public abstract class ONXmlString
	{
		...
		public static ONString XML2ON(XmlReader xmlReader, double dtdVersion, string xmlElement)
		{
			...
			{
				throw new ONXMLFormatException(e, "String");	
			}
		...
		{
			if (data == "")
				throw new ONXMLFormatException(null, "String");

			try
			{
				return new ONString(data);
			}
			catch(Exception e)
			{
				throw new ONXMLFormatException(e, "String");
