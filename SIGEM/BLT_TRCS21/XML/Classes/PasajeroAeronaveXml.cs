...
namespace SIGEM.Business.XML
{
	...
	/// </summary>
	[ONGateXMLAttribute("PasajeroAeronave")]
	internal class PasajeroAeronaveXml : ONXml
	{
		#region Properties
		...
		/// Default Constructor
		/// </summary>
		public  PasajeroAeronaveXml() : base("PasajeroAeronave")
		{
		}
		#endregion
		...
		{
			// Process the service arguments
			ONServiceInfo lSInfo = new ONServiceInfo("Clas_1348178542592177Ser_2_Alias", PasajeroAeronaveClassText.Delete_instanceServiceAlias, "Clas_1348178542592177_Alias", PasajeroAeronaveClassText.ClassAlias);
			lSInfo.AddOIDArgument("p_thisPasajeroAeronave", false, "PasajeroAeronave", "Clas_1348178542592177Ser_2Arg_1_Alias", PasajeroAeronaveClassText.Delete_instance_P_thisPasajeroAeronaveArgumentAlias);
			...
			{
				throw new ONServiceArgumentsException(e, "Clas_1348178542592177_Alias", PasajeroAeronaveClassText.ClassAlias, "Clas_1348178542592177Ser_2_Alias", PasajeroAeronaveClassText.Delete_instanceServiceAlias);
			}
			...
			try
			{
				...
				{	
					lServer.Delete_instanceServ(lP_thisPasajeroAeronaveArg);
					lInstance = lServer.Instance;
				}	
				ticket = lOnContext.GetTicket(dtdVersion, clientName);
			}
		...
		public override ONCollection QueryByOid(ref string ticket, ref ONOid agentOid, XmlReader xmlReader, ONDisplaySet displaySet, double dtdVersion, string clientName)
		{
			...
			// Execute
			PasajeroAeronaveQuery lQuery = new PasajeroAeronaveQuery(lOnContext);
		...
		/// <param name="xmlReader">XML with the request message</param>
		/// <param name="dtdVersion">Version of DTD that follows the XML message</param>
		public PasajeroAeronaveLMDFilter GetFilter_LMD(XmlReader xmlReader, double dtdVersion)
		{
			// Create filter
			PasajeroAeronaveLMDFilter lFilter = new PasajeroAeronaveLMDFilter();
			
			// Process the variable filters
			ONServiceInfo lSInfo = new ONServiceInfo("", "LMD", "Clas_1348178542592177_Alias", "PasajeroAeronave");
			...
			{
				throw new ONServiceArgumentsException(e, "Clas_1348178542592177_Alias", "PasajeroAeronave", "", "LMD");
			}
		...
		/// <param name="xmlReader">XML with the request message</param>
		/// <param name="dtdVersion">Version of DTD that follows the XML message</param>
		public PasajeroAeronaveLMDFilter GetFilter_FUM(XmlReader xmlReader, double dtdVersion)
		{
			// Create filter
			PasajeroAeronaveLMDFilter lFilter = new PasajeroAeronaveLMDFilter();
			
			// Process the variable filters
			ONServiceInfo lSInfo = new ONServiceInfo("", "FUM", "Clas_1348178542592177_Alias", "PasajeroAeronave");
			...
			{
				throw new ONServiceArgumentsException(e, "Clas_1348178542592177_Alias", "PasajeroAeronave", "", "FUM");
			}
		...
		public override void ONQuery2XML(ONOid agentOid, XmlWriter xmlWriter, ONCollection val, ONOid startRowOID, int blockSize, ONDisplaySet displaySet, double dtdVersion)
		{
			...
			xmlWriter.WriteAttributeString("Class", "PasajeroAeronave");
			xmlWriter.WriteStartElement("Head.OID.Field");
			xmlWriter.WriteAttributeString("Name", "id_PasajeroAeronave");
			...
			foreach (ONDisplaySetItem lDisplaySetItem in displaySet)
			{
				...
				string lType = ONInstance.GetTypeOfAttribute(typeof(PasajeroAeronaveInstance), new ONPath(lDisplaySetItem.Path));
				if(lType == "")
					lType = "string";
			...
			{
				PasajeroAeronaveInstance lInstance = val[i++] as PasajeroAeronaveInstance;
			
				xmlWriter.WriteStartElement("R");
				ONXmlAutonumeric.ON2XML(xmlWriter, lInstance.Oid.Id_PasajeroAeronaveAttr, dtdVersion, ONXml.XMLTAG_O);
